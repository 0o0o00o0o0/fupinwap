  ...
  <div class="body-wrap">
    <div class="hauto">
      ...
      <div class="address-save">
        <button class="address-save-btn" type="button" @click="saveAddress">
          保存
        </button>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    saveAddress() {
      var self = this;
      if (this.openId && this.username && this.phone && this.address) {
        var params = {};
    ...
    mygets() {
      let redirect_urls= encodeURIComponent("http://wap.chhtf.com/#/addAddress");
