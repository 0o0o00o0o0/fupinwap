  ...
  <div class="index">
    ...
    <div class="fupin-area">
      ...
      <div
        ...
        :style="'width:17%;margin-top:'+(item.more||index<5?'0':'1rem')"
        @click="gotoDetail(item)"
      >
        <span
    ...
    <div
      class="rec"
      style=";margin: 1rem 0;background:rgb(245, 245, 245)"
    >
      <img
    ...
    vertical-align: text-bottom"
      > {{labelName}} <div v-show="presellTimeStr">({{tempString}}{{presellTimeStr}})</div>
    </div>
    <div
...
">
        ...
        <div
          v-show="item.showPre"
          style="position:absolute;opacity:.65;width:3rem;height:3rem;background-color:rgb(46,126,94);line-height:3rem;border-radius:3rem;top:0;right:0;color:white"
        >
          预售
        </div>
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      swipes: [
        ...
        {
          url: require("../../assets/images/干辣椒.jpg"),
          id: 1000
        },
        {
          url: require("../../assets/images/土鸡蛋.jpg"),
          id: 2000
        }
      ],
      classi_icons: [
  ...
  methods: {
    gotoDetail(item) {
      ...
      this.$router.push({
        name: "comList",
        query: { type: "place", label: item.title, tempString: item.tempString }
      });
    },
    mygets() {
