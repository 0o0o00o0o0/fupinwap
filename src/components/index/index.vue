      ...
      <div style="height: 25rem">
        ...
        <div class="swiper-box">
          <van-swipe :autoplay="3000" indicator-color="white">
            ...
            >
              <img style="width: 100%; height: 8rem" :src="image.url" alt="" />
            </van-swipe-item>
          </van-swipe>
        </div>
        <div class="classi-icon">
          <div @click="gotoZhunong" class="classi-item">
            <img
              class="classi-item-img"
              src="../../assets/images/fpzq1.png"
              alt=""
            />
            <span class="classi-item-title">助农城市</span>
          </div>
          <div
            @click="
              $router.push({
                name: 'comList',
                query: { type: 'label', label: item.title },
              })
            "
            class="classi-item"
          ...
          >
            <img class="classi-item-img" :src="item.url" alt="" />
            <span class="classi-item-title">{{ item.title }}</span>
          </div>
        </div>
      </div>
    </div>
    <recommend title="助农推荐" :recommonds="fpRecomArr" componentType="fp" />
    <!-- <recommend title="精品推荐" :recommonds="jpRecomArr" componentType="jp" /> -->
    <!-- <div
      class="rec"
      style="background: white; margin: 1rem 0; padding: 0.7rem 0"
    >
      <van-tabs v-model="active" type="card" @change="changeTabs">
        <van-tab
    ...
    <!-- <div style="min-height: calc(100% - 60px)">
      ...
      <div v-show="labelcommdyList.length" class="labelCommidyList">
        ...
        >
          ...
          <div
            style="height: 1rem; float: left; color: red; text-indent: 0.5rem"
          > -->
            <!-- <img
