    ...
    <div class="hauto">
      ...
      <div class="my-order-wrap">
        <div class="header clearfix">
          ...
          <div class="all" @click="goToOrderList(0)"><span>查看全部订单</span><van-icon name="arrow" /></div>
        </div>
        <div class="order-list flex">
          <div class="order-item" @click="goToOrderList(1)">
            <p class="icon"><img src="../../assets/images/pay.png" alt=""></p>
            <span class="title">待付款</span>
          </div>
          <div class="order-item" @click="goToOrderList(2)">
            <p class="icon"><img src="../../assets/images/car.png" alt=""></p>
            <span class="title">待发货</span>
          </div>
          <div class="order-item" @click="goToOrderList(3)">
            <p class="icon"><img src="../../assets/images/log.png" alt=""></p>
            <span class="title">待收货</span>
          </div>
          <div class="order-item" @click="goToOrderList(4)">
            <p class="icon"><img src="../../assets/images/money.png" alt=""></p>
            <span class="title">待评价</span>
          </div>
        </div>
      </div>
      <div class="personal-setting flex">
        <div @click="goToFuBag">
        ...
        <div @click="goToAddress">
          <p class="icon"><van-icon name="location-o" /></p>
...
export default {
  ...
  methods:{
    ...
    // mygets() {
    //   var redirect_urls= encodeURIComponent("http://wap.chhtf.com/#/navContainer/personal");
