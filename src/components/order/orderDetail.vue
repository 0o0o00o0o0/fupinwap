...
"
            ...
            <div class="product-list">
              ...
              >
                  ...
                  <div class="content">
                    ...
                    <div class="info">
                      <div class="price">
                        ...
                        ￥{{item.unitPrice}} *{{item.commoditySize}}</div>
                    </div>
                  </div>
                ...
                <div
                  class="delivery clearfix"
                  v-show="item.deliveryNumber"
                >
                  ...
                  <span class="company clearfix"><label for="">快递单号:</label><span class="pull-right">{{item.deliveryNumber}}</span><span
        ...
        <div class="money-info-wrap">
          ...
          <div class="clearfix price-money">
            ...
            <div class="price">
              <font>
                <!-- <img src="../../assets/images/fu.png" alt=""> -->
                ￥</font><span>{{orderInfo.actualPayment}}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div
        class="footer"
        v-show="orderInfo.orderStatus == 0"
      >
        <van-button
          type="primary"
          class="continue-pay"
    ...
    vertical-align: middle;"
                ...
                alt=""
                srcset=""
              >银联支付 <span style="font-size:.8rem;;color:red;font-weight:600">(支持长沙农商银行信用卡)</span></div>
            <!-- <span>&emsp; -->
            <!-- (剩余:  -->
          ...
          >
            ...
            <van-icon
              name="success"
              v-if="payMethodPopup == 1"
            />
            <!-- <van-icon name="success" v-else style="visibility: hidden;"/></span> -->
          </div>
          <!-- <div class="fu-bag-pay" @click="handleClickFuBagPay">
              <span>福包支付</span><span>&emsp;(剩余: 
                <img src="../../assets/images/fu.png">
                ￥{{accountInfo.accountBalance | toFixedFilter}})</span>&emsp;<span class="add-card-link" v-if="accountInfo.accountBalance < totalPrice"  @click="goToPayMoney(accountInfo,'bag')">去充值</span>
              <span class="selected">
...
export default {
  ...
  watch: {
    userCardNumber(val) {
      this.$nextTick(() => {
        let str = String(this.userCardNumber)
          .split(" ")
          .join("");
        if (str.length > 4)
  ...
  computed: {
    canIsubmit() {
      const t = String(this.userCardNumber)
        .split(" ")
        .join("");
