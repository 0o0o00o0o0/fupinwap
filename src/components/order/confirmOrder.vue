          ...
          <div class="clearfix price-money">
            ...
            <div class="price">
              <font>
                <!-- <img src="../../assets/images/fu.png" alt=""> -->
                ￥
              </font><span>{{totalPrice | toFixedFilter}}</span>
            </div>
          </div>
           <div class="clearfix price-money">
          
              <van-field style="padding: 0px 0" type="text"  label="备注" v-model="leaveMessage" placeholder='请输入备注' />
          </div>
        </div>
      </div>
