...
export default {
  ...
  methods:{
    ...
    goToPayment(number){
      ...
      params.rechargeRecord.rechargeNumber = curDate.getTime();
      ...
      self.$axios.post({
        ...
        if (typeof WeixinJSBridge == "undefined"){
          if( document.addEventListener ){
            document.addEventListener('WeixinJSBridgeReady', self.onBridgeReady(data,params.rechargeRecord.rechargeNumber), false);
          }else if (document.attachEvent){
            document.attachEvent('WeixinJSBridgeReady', self.onBridgeReady(data,params.rechargeRecord.rechargeNumber)); 
            document.attachEvent('onWeixinJSBridgeReady', self.onBridgeReady(data,params.rechargeRecord.rechargeNumber));
          }
        }else{
    ...
    mygets() {
      var redirect_urls= encodeURIComponent("http://wap.chhtf.com/#/faceValueItem");
